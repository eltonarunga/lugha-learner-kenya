-- First add the missing African languages to the languages table
INSERT INTO languages (code, name, native_name, flag_emoji) VALUES
('nandi', 'Nandi', 'Kalenjin', '🇰🇪'),
('luo', 'Luo', 'Dholuo', '🇰🇪'),
...
'What wisdom does "Haba ya mvua haijui mlina unaotetemeka" convey?',
'Haba ya mvua haijui mlina unaotetemeka',
'We often do not realize the impact of our actions on others',
'swahili',
ARRAY['We do not realize our impact on others', 'Mountains fear rain clouds', 'Weather is unpredictable', 'Clouds are ignorant'],
0,
...
'If you do not listen to your parents, the world will teach you',
'swahili',
...
'What does the Luo proverb "Jakom ok nyal loko wi nam" teach us?',
'Jakom ok nyal loko wi nam',
'True leadership requires the consent and support of the people',
'luo',
ARRAY['Leadership requires people consent', 'Leaders are powerless', 'People never change their minds', 'Democracy is impossible'],
0,
...
'The Kikuyu saying "Gutiri mwana wa nyina wiki" means:',
